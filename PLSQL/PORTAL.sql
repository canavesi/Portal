...
--   Script Created at  : 03/12/2020 16:30:17 
--   Physical Location  :  
--   Notes              :  
--
...
-- Object Counts: 
--   Indexes: 7         Columns: 8          
--   Packages: 1        Lines of Code: 147 
--   Package Bodies: 1  Lines of Code: 427 
--   Sequences: 9 
--   Tables: 7          Columns: 43         Constraints: 15     
--   Triggers: 1 
...
begin
   ...
   if ( tipo_ = 'TXT' ) then
      ...
      perro := 'Tipo de arquivo não identificado.';
      return false;
   end if;
